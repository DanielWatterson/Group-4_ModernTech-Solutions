<template>
  <div class="intro-container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="content-box text-center p-5 shadow-lg" v-if="!showVideo">
      ...
      <button class="btn btn-intro-primary" @click="playVideo">
...
// Correct way to reference assets in Vue 3 + Vite
const videoSrc = new URL('../assets/Hailou_Video_454780089505865728.mp4', import.meta.url).href;
